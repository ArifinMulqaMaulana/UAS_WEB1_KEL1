...
LEFT JOIN news_catalog ON MONTH(news_catalog.date) = months.m AND YEAR(news_catalog.date) = ? AND news_catalog.date IS NOT NULL GROUP BY months.m ORDER BY months.m;");
